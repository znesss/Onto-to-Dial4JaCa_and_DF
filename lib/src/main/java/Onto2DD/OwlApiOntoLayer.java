...
public class OwlApiOntoLayer {
    protected OWLOntology ontology = null;
    protected OWLReasoner reasoner = null;
    protected String ontologyFilePath = null;

    public OwlApiOntoLayer(String ontologyFilePath) throws OWLOntologyCreationException {
        IRI iri = IRI.create((File)new File(ontologyFilePath));
        this.ontologyFilePath = iri.toString();
        System.out.println(String.format("%s %s", "IRI ", iri.toString()));
        System.out.println("Java - OwlApiOntoLayer ontologyFilePath " + ontologyFilePath);
        this.ontology = OwlApiOntoLayer.loadOntology(iri);
    }
    public OwlApiOntoLayer(String ontologyFilePath, OWLReasoner reasoner) throws OWLOntologyCreationException {
        IRI iri = IRI.create((File)new File(ontologyFilePath));
        this.ontologyFilePath = iri.toString();
        this.ontology = OwlApiOntoLayer.loadOntology(iri);
        System.out.println("Java - OwlApiOntoLayer reasoner " + reasoner);
    ...
    public static OWLOntology loadOntology(IRI ontologyIRI) throws OWLOntologyCreationException {
        ...
        OWLOntologyManager ontologyManager = OwlApiOntoLayer.createOntologyManager();
    ...
    public static OWLClass getOWLThing() {
        return OwlApiOntoLayer.createOntologyManager().getOWLDataFactory().getOWLThing();
    }
